...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *cancelItem = [[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:NSLocalizedString(@"Cancel", nil)] style:UIBarButtonItemStyleBordered target:self action:@selector(cancelGdriveSignIn:)];
